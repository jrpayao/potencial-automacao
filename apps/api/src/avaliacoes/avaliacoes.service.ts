...
export class AvaliacoesService {
  ...
  private mapAvaliacaoToDraft(avaliacao: Avaliacao): DraftAvaliacaoDto {
    return {
      ...
      justifReducaoSla: avaliacao.deJustifReducaoSla ?? undefined,
      notaAbrangencia: avaliacao.nuNotaAbrangencia,
      justifAbrangencia: avaliacao.deJustifAbrangencia ?? undefined,
      ...
      justifVolumeMensal: avaliacao.deJustifVolumeMensal ?? undefined,
